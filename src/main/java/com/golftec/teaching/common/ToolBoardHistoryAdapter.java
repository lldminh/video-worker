 ...
 */
public class ToolBoardHistoryAdapter implements JsonDeserializer<ToolBoardHistory> {

    @Override
    public ToolBoardHistory deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ToolBoardHistory history = GTUtil.gsonBasic.fromJson(json, ToolBoardHistory.class);
